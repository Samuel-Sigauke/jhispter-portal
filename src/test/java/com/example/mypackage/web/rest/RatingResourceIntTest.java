...
public class RatingResourceIntTest {
    ...
    private static final RatingPoints DEFAULT_RATING_POINTS = RatingPoints.ONE;
    private static final RatingPoints UPDATED_RATING_POINTS = RatingPoints.TWO;

    private static final String DEFAULT_RATED_BY = "AAAAAAAAAA";
    private static final String UPDATED_RATED_BY = "BBBBBBBBBB";
    ...
    public void createRating() throws Exception {
        ...
        assertThat(testRating.getRatingPoints()).isEqualTo(DEFAULT_RATING_POINTS);
        assertThat(testRating.getRatedBy()).isEqualTo(DEFAULT_RATED_BY);
    ...
    public void getAllRatings() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ratingPoints").value(hasItem(DEFAULT_RATING_POINTS.toString())))
            .andExpect(jsonPath("$.[*].ratedBy").value(hasItem(DEFAULT_RATED_BY.toString())))
    ...
    public void getRating() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings/{id}", rating.getId()))
            ...
            .andExpect(jsonPath("$.ratingPoints").value(DEFAULT_RATING_POINTS.toString()))
            .andExpect(jsonPath("$.ratedBy").value(DEFAULT_RATED_BY.toString()))
    ...
    public void updateRating() throws Exception {
        ...
        updatedRating
            .ratingPoints(UPDATED_RATING_POINTS)
            .ratedBy(UPDATED_RATED_BY)
        ...
        Rating testRating = ratingList.get(ratingList.size() - 1);
        assertThat(testRating.getRatingPoints()).isEqualTo(UPDATED_RATING_POINTS);
        assertThat(testRating.getRatedBy()).isEqualTo(UPDATED_RATED_BY);
