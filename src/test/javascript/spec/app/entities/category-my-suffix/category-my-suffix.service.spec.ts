...
describe('Service Tests', () => {
    ...
    describe('CategoryMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CategoryMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return CategoryMySuffix', () => {

                let entity: CategoryMySuffix;
                service.find(123).subscribe((_entity: CategoryMySuffix) => {
                    entity = _entity;
                });
