...
describe('Service Tests', () => {
    ...
    describe('CommentMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CommentMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return CommentMySuffix', () => {

                let entity: CommentMySuffix;
                service.find(123).subscribe((_entity: CommentMySuffix) => {
                    entity = _entity;
                });
