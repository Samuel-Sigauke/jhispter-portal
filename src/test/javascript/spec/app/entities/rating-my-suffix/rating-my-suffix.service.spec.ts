...
describe('Service Tests', () => {
    ...
    describe('RatingMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RatingMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return RatingMySuffix', () => {

                let entity: RatingMySuffix;
                service.find(123).subscribe((_entity: RatingMySuffix) => {
                    entity = _entity;
                });
