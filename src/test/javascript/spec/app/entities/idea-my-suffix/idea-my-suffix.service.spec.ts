...
describe('Service Tests', () => {
    ...
    describe('IdeaMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(IdeaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ideas';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return IdeaMySuffix', () => {

                let entity: IdeaMySuffix;
                service.find(123).subscribe((_entity: IdeaMySuffix) => {
                    entity = _entity;
                });
