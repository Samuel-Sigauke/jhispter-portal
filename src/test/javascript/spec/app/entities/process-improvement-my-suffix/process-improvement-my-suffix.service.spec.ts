...
describe('Service Tests', () => {
    ...
    describe('ProcessImprovementMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProcessImprovementMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/process-improvements';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProcessImprovementMySuffix', () => {

                let entity: ProcessImprovementMySuffix;
                service.find(123).subscribe((_entity: ProcessImprovementMySuffix) => {
                    entity = _entity;
                });
